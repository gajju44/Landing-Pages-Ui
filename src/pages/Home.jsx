    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-2">
            ...
            <div className="relative bg-white rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 h-full flex flex-col">
              <div className="h-48 bg-[#eefac8] flex items-center justify-center p-6 group-hover:scale-105 transition-transform duration-500">
                 <div className="bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-sm">
                    <span className="text-2xl font-bold text-gray-900">Page1</span>
                 </div>
              </div>
          ...
          {/* Card for Page 2 */}
          <Link to="/page2" className="group block">
            <div className="relative bg-white rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 h-full flex flex-col">
              <div className="h-48 bg-purple-100 flex items-center justify-center p-6 group-hover:scale-105 transition-transform duration-500">
                 <div className="bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-sm">
                    <span className="text-2xl font-bold text-gray-900">Page2</span>
                 </div>
              </div>
              <div className="p-8 flex-1">
                
                <h3 className="mt-4 text-2xl font-bold text-gray-900 group-hover:text-purple-600 transition-colors">
                  Page2
                </h3>
                <p className="mt-2 text-gray-500">
                  A comprehensive landing page with stats, testimonials, and feature sections.
                </p>
          ...
          <div className="relative bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200 h-full flex flex-col items-center justify-center p-8 text-center hover:border-gray-300 transition-colors">
            ...
            <p className="mt-2 text-gray-400">
              New high-converting layouts coming soon
            </p>
          </div>
        </div>
      </div>
